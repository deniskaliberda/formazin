...
## Automatische Eingangsbestätigung · 15.09.2026
Beide bestehenden Formulare behalten ihre sichtbare Gestaltung. Nach erfolgreicher Büro-Mail oder gespeicherter Energie-Anfrage einfache Textmail vom bestehenden kontakt@formazin-partner.de mit Rückantwort ans Büro. Text: „Guten Tag, vielen Dank für Ihre Anfrage. Wir bearbeiten Ihr Anliegen. Unser Büro wird sich bei Ihnen melden.“ Bestehende Firmensignatur. Keine Frist, keine Fallannahme, keine Übernahme von Nutzereingaben. Resend-Idempotenz für Büro-Mail und empfängerbezogene Bestätigung (24 Stunden), Eingabegrenzen, Origin-Prüfung und unsichtbares Botfeld. Bestätigungsfehler machen angenommene Anfragen nicht rückwirkend fehlerhaft. Kontrollierte Tests ohne echte Empfänger. Automatischer Ablauf ausdrücklich autorisiert; historische Nachsendung nur nach Einzelfreigabe.


## Eingangsbestätigung im Formazin-Stil · 15.09.2026
Nutzer beauftragt jetzt ausdrücklich Markenstil und einmaligen Versand der ersten Bestätigung. Vorhandenes PNG-Logo `public/images/FuP-Logo2025-quer-RGB.png` aus der Website-Navigation, unverändert über kanonische HTTPS-URL. Weißes Mailblatt, Formazin-Blau #2d4196, Text #1e293b und Fußbereich #f3f4f6. Mailtaugliches Tabellenlayout mit Inline-CSS, maximal600px, mobil fließend und keine feste Mindestbreite. Archivo falls lokal verfügbar, Arial/Helvetica als zuverlässige Ersatzschrift, keine extern geladenen Fonts. Kurzer bestätigter Wortlaut und Klartextalternative unverändert. Kein zusätzlicher Werbetext oder Call-to-Action. Einmalige Nachsendung jetzt autorisiert nach frischer Duplikatprüfung; denselben empfängerbezogenen Schlüssel wie die Automatik verwenden.


## Bestätigung25 Minuten nach Eingang · 15.09.2026
Nutzer nimmt den Formazin-Stil ausdrücklich ab und beauftragt25 Minuten Verzögerung für beide Formularwege. HTML/Klartext unverändert als dauerhafte Vorlage behalten. Zeitanker ist Eintritt in den serverseitigen POST-Handler vor Validierung, Speicherung und Büro-Mail. Resend erhält einen absoluten UTC-Termin Eingang+25 Minuten. Büro-Mail weiterhin ohne Termin sofort. Kein Prozess-Timer als Versandplan, keine Codex-Automation, keine historischen Nachsendungen. Empfänger-Idempotenz24h beibehalten: späterer Wiederholungsversuch mit anderem Timestamp darf den bereits vorhandenen Versand nicht ersetzen. Anbieter-Konflikt für einen bereits verwendeten Schlüssel als Duplikat behandeln. Kurze begrenzte Wiederholung nur für technische Übergabefehler, kein sofortiger Fallbackversand. Prüfung gegen kontrollierte Uhr und Resend-Testadresse. Nutzer autorisiert Veröffentlichung.
