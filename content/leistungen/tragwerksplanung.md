---
reihenfolge: 1
kurz_titel: Tragwerksplanung & Statik
...
Der Umfang richtet sich nach Ihrem Vorhaben und der vereinbarten Fachplanung:

- Statische Berechnungen und Nachweise
- Standsicherheitsnachweise nach Bauordnung
- Konstruktiver Ingenieurbau (Stahlbeton, Stahl, Holz, Mauerwerk)
...
Welche Konstruktion geeignet ist, hängt unter anderem von Nutzung, Spannweiten und vorhandener Bausubstanz ab.

### Stahlbeton
Tragende Bauteile wie Bodenplatten, Wände, Stützen und Decken aus Stahlbeton.
...
Wir nehmen Bauvorhaben, Baugrund und die Vorgaben der Objektplanung auf.

### Vorbemessung und Variantenberatung
Tragsystem festlegen und Varianten hinsichtlich Konstruktion, Ausführung und Wirtschaftlichkeit abwägen.

### Statische Berechnung
Nachweise der Standsicherheit nach geltender Bauordnung und Normen.

### Ausführungs- und Schalpläne
Bewehrungs- und Konstruktionspläne, mit denen die Baustelle arbeiten kann.

### Begleitung der Ausführung
Im vereinbarten Leistungsumfang begleiten wir die Ausführung und stimmen Rückfragen mit Objektplanung und Baustelle ab.

## Für wen

- Öffentliche Auftraggeber
- Private Bauherren
- Architekturbüros (als externer Fachplaner)
- Eigentümer von Bestandsgebäuden

## Warum Formazin & Partner

**Tragwerk, Architektur und Brandschutz sitzen bei uns in einem Büro.** Das verkürzt Abstimmungswege und vermeidet die typischen Reibungsverluste zwischen getrennten Planern. Unser Büro ist seit 1990 tätig und plant Bauvorhaben in Berlin und Brandenburg. Architektur, Statik und Brandschutz können dadurch von Beginn an abgestimmt werden.
...
„Statik" meint die rechnerischen Nachweise der Standsicherheit. „Tragwerksplanung" ist der umfassendere Begriff und schließt Entwurf, Konstruktion und Bemessung des gesamten Tragsystems ein.

### Für welche Bauvorhaben braucht es einen Standsicherheitsnachweis?
Das hängt vom Bauvorhaben und dem jeweiligen Landesrecht ab. Bei Neubauten und Eingriffen in tragende Bauteile klären wir, welche statischen Nachweise erforderlich sind. Die Erstellung eines Nachweises und seine bauaufsichtliche Prüfung sind dabei unterschiedliche Anforderungen.
