...
export const energieberatungContent: EnergiePageContent = {
  ...
  featureGrid: {
    heading: "Welche Energieberatung brauchen Sie?",
    intro:
      "Wählen Sie die Leistung für Ihr Vorhaben. Auf der jeweiligen Seite finden Sie den Umfang, die benötigten Unterlagen und den Weg zur Anfrage.",
    items: [
      {
        icon: "FileText",
        graphic: "fahrplan",
        title: "Sanierungsfahrplan (iSFP)",
        text: "Sie möchten Ihr Haus schrittweise sanieren? Wir erfassen den Bestand und ordnen geeignete Maßnahmen.",
      ...
      },
      {
        ...
        text: "Sie setzen eine geförderte Sanierung um? Wir begleiten die fachlichen Nachweise und die Ausführung im vereinbarten Umfang.",
      ...
      },
      {
        ...
        text: "Sie benötigen einen Energieausweis für Verkauf oder Vermietung? Wir klären die Ausweisart und die erforderlichen Gebäudedaten.",
      ...
      },
      {
        ...
        text: "Sie planen einen Neubau oder Umbau? Wir prüfen den benötigten energetischen Nachweis für Ihr Vorhaben.",
      ...
      },
      {
        ...
        text: "Sie möchten passende Förderprogramme finden? Wir prüfen Voraussetzungen und begleiten die vereinbarten Anträge und Nachweise.",
